...
class UserDBStorageTest {
    ...
    void addFriend() {
        ...
        friendStorage.addFriend(firstUserId, user.getId());
    ...
    public void confirmFriend() {
        assertThat(friendStorage.isConfirmFriend(3L, 4L))
                .isPresent().hasValueSatisfying(i -> assertThat(i).isFalse());
        friendStorage.confirmFriend(3L, 4L);
        assertThat(friendStorage.isConfirmFriend(3L, 4L))
    ...
    void deleteFriend() {
        List<User> users = userStorage.findAll();
        friendStorage.deleteFriend(users.get(0).getId(), users.get(1).getId());
